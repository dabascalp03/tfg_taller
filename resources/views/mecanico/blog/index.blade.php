...
<div class="container">
    ...
    <a href="{{ route('mecanico.blog.create') }}" class="btn btn-success btn-sm mb-3">Crear Nuevo Post</a>
            ...
            <tbody id="postTable">
                @foreach($posts as $post)
                    <tr class="post-row">
                        ...
                        <td>
                            <a href="{{ route('mecanico.blog.edit', $post->id) }}" class="btn btn-warning btn-sm">Editar</a>
                            <form action="{{ route('mecanico.blog.destroy', $post->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
