...
<div class="container mt-4">
    ...
    <form action="{{ route('mecanico.blog.store') }}" method="POST" class="dropzone" id="image-upload">
        @csrf
        ...
        <a href="{{ route('mecanico.blog.index') }}" class="btn btn-secondary mt-3">Cancelar</a>
    </form>
</div>
<script>
    Dropzone.options.myDropzone = {
    url: "{{ route('mecanico.blog.storeImage') }}", // Ruta para subir las imágenes
