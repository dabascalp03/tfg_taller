...
<div class="container">
    ...
    <a href="{{ route('mecanico.ofertas.create') }}" class="btn btn-success btn-sm mb-3">Nueva Oferta</a>
    ...
    <table class="table table-striped">
        ...
        <tr class="offer-row">
            ...
            <td>
                <a href="{{ route('mecanico.ofertas.edit', $oferta->id) }}" class="btn btn-warning btn-sm">Editar</a>

                <form action="{{ route('mecanico.ofertas.destroy', $oferta->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
